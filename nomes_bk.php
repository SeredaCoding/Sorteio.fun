			...
			<div class="container text-center">
				<div class="row justify-content-md-center">
							...
							<!-- Formulário para adicionar nomes -->
								<form method="post" action="sorteio_nomes">
									...
									<div class="input-group mb-3">
									  <!--<span class="input-group-text bg-light">Novo nome:</span>-->
								      	<input style="text-align:center;" class="form-control" type="text" name="novoNome" minlength="3" maxlength="33" placeholder="Digite aqui um nome para ser sorteado..." required>
						    	...
						    	<div class="container text-center">
									<div class="row justify-content-md-center">
										<div class="col-6 col-md-auto col-md-3 col-lg-4 centralizar">
								            <div class=" p-2 rounded border mb-2 mt-4 flutuar " id="nome_sorteado">
												<?php
					...
					<div class="col-12">
						...
						<form method="post" action="sorteio_nomes">
						    <button class="btn btn-success mb-3 mt-3" type="submit" name="sortear">Sortear</button>
						</form>
					</div>	
					...
					<?php
					    	...
					    	<div class="col-12">
					    		...
					    		<div class="container text-center">
									    <div class="row justify-content-md-center">
									        ...
									        <?php //percorrendo os nomes da lista
					 ...
					 <div class="col-12">
						...
						<form method="post" action="resetar_nomes.php">
						    <button class="btn btn-danger m-1 mb-2" type="submit" name="resetar" id="btnResetar">Resetar</button>
						</form>
					 </div>
					...
					<?php 
					    ...
					    if (!isset($_GET['resetar']) && !isset($_SESSION['nomes']) && empty($_SESSION['nomes'])){?>
					    	<script>
								document.getElementById('btnResetar').remove();
							</script><?php
					    }
