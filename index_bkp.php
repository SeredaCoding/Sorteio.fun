...
<html>
	...
	<body>
		...
		<div class="container text-center">
		  <div class="row justify-content-md-center">
		    ...
		    <div class="col-md-auto">
		      <h4 class="centralizar mt-2">Sorteie seu número abaixo:</h4>
		    </div>
			...
			<div class="container text-center">
			  <div class="row justify-content-md-center">
			    ...
			    <div class="col col-lg-2">
			    	<p>Sortear:</p>
			      	<input class="" type="number" name="quantidade" min="1" value="<?php
			    ...
			    <div class="col-md-auto">
			    	<p>Entre:</p>
			      	<input class="" type="number" name="entre1" min="1" value="<?php 
			    ...
			    <div class="col col-lg-2">
			    	<p>e:</p>
			      	<input class="" type="number" name="entre2" min="1" value="<?php 
		...
		if(isset($_SESSION['sorteio'])){
			...
			<div class="col-sm-auto centralizar">
